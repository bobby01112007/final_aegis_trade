...
const REGULATORY_LAWS_DATA: RegulatoryLaw[] = [
  ...
  // China Regulations (🇨🇳 Accent color: #DE2910)
  {
    ...
    nameVi: 'Luật An toàn Thực phẩm Cộng hòa Nhân dân Trung Hoa (Sửa đổi 2021)',
    body: 'NHC / SAMR',
    ...
    coversVi: 'Mô hình khung pháp lý an toàn thực phẩm cốt lõi tại Trung Quốc — quy định mọi sản phẩm thực phẩm nhập khẩu bắt buộc tuân thủ bộ tiêu chuẩn quốc gia GB.',
    link: 'https://www.fas.usda.gov/data/china-china-s-food-safety-law',
    accentColor: '#DE2910',
    flag: '🇨🇳',
    articlesCount: 104,
    lastUpdated: 'May 2026',
  ...
  },
  {
    id: 'cn-decree248',
    country: 'China',
    name: 'GACC Decree 248 — Overseas Registration',
    nameVi: 'Lệnh 248 của GACC — Đăng ký Cơ sở Sản xuất Thực phẩm Nước ngoài',
    body: 'GACC',
    bodyVi: 'Tổng cục Hải quan Trung Quốc (GACC)',
    covers: 'Registration of overseas food manufacturers on CIFER before exporting to China; 18 high-risk categories require competent authority recommendation.',
    coversVi: 'Yêu cầu đăng ký bắt buộc của nhà xuất khẩu và cơ sở sản xuất trên hệ thống CIFER trước khi đưa hàng đi; 18 danh mục sản phẩm rủi ro cao cần có văn bản đề xuất từ bộ ngành quốc gia sở tại.',
    link: 'https://english.customs.gov.cn',
    accentColor: '#DE2910',
    flag: '🇨🇳',
    articlesCount: 28,
    lastUpdated: 'May 2026',
    ...
    applicableProduceVi: ['Đăng Ký Cơ Sở', 'Nhà Xuất Khẩu', '18 Nhóm Rủi Ro Tinggi'],
  ...
  },
  {
    id: 'cn-decree280',
    country: 'China',
    name: 'GACC Decree 280',
    nameVi: 'Lệnh 280 của GACC — Quy Trình Xét Duyệt Đăng Ký Cập Nhật',
    body: 'GACC',
    bodyVi: 'Tổng cục Hải quan Trung Quốc (GACC)',
    covers: 'Replaces Decree 248 — updated registration process, renewal conditions, exemptions for overseas establishments.',
    coversVi: 'Thay thế cho Lệnh 248 — điều chỉnh quy trình cập nhật thời điểm đăng ký trực tiếp, điều khoản gia hạn và một số trường hợp miễn trừ cơ sở xuất khẩu.',
    link: 'https://english.customs.gov.cn',
    accentColor: '#DE2910',
    flag: '🇨🇳',
    articlesCount: 25,
  ...
  },
  {
    ...
    nameVi: 'Lệnh 249 của GACC — Biện pháp Quản lý An toàn Thực phẩm Xuất nhập khẩu',
    body: 'GACC',
    bodyVi: 'Tổng cục Hải quan Trung Quốc (GACC)',
    covers: 'Inspection, quarantine, labeling, packaging, and recall of imported food.',
    coversVi: 'Quy tắc rà soát biên giới, kiểm dịch nghiêm ngặt, ghi nhãn bao bì và trách nhiệm thu hồi nông sản, thực phẩm nhập khẩu không đạt tiêu chuẩn kỹ thuật.',
  ...
  },
  {
    id: 'cn-gb7718',
    country: 'China',
    name: 'GB 7718-2025 — Food Labeling Standard',
    nameVi: 'GB 7718-2025 — Tiêu chuẩn Ghi nhãn Thực phẩm Bao gói sẵn Quốc Gia',
    body: 'NHC / SAMR',
    bodyVi: 'Ủy ban Y tế Quốc gia (NHC) / Tổng cục Quản lý Giám sát Thị trường (SAMR)',
    covers: 'National standard for pre-packaged food labels — mandatory allergen declaration.',
    coversVi: 'Tiêu chuẩn quốc gia kiểm soát chặt chẽ quy chuẩn nhãn bao bì thực phẩm đóng gói sẵn — buộc phải kê khai rõ ràng minh bạch các nhân tố gây dị ứng.',
    link: 'https://www.fas.usda.gov/data/china-nhc-publishes-updated-national-food-safety-standards',
    accentColor: '#DE2910',
    flag: '🇨🇳',
    articlesCount: 15,
  ...
  },
  {
    id: 'cn-gb2763',
    country: 'China',
    name: 'GB 2763 — Maximum Pesticide Residue Limits',
    nameVi: 'GB 2763 — Giới hạn Dư lượng Tối đa Thuốc Bảo vệ Thực vật',
    body: 'NHC',
    bodyVi: 'Ủy ban Y tế Quốc gia (NHC)',
    covers: 'Maximum allowable pesticide residue levels in food products.',
    coversVi: 'Xác lập ngưỡng hàm lượng tồn dư tối đa cho phép đối với các hoạt chất thuốc hóa sinh, thuốc diệt cỏ diệt sâu trong nông sản tiêu dùng.',
    link: 'https://english.customs.gov.cn',
    accentColor: '#DE2910',
    flag: '🇨🇳',
    articlesCount: 100,
  ...
  },
  {
    id: 'cn-cifer',
    country: 'China',
    name: 'CIFER Registration Portal',
    nameVi: 'Cổng Đăng Ký Hệ thống Hải quan CIFER',
    body: 'GACC',
    bodyVi: 'Tổng cục Hải quan Trung Quốc (GACC)',
    covers: 'Online portal to register overseas food production facilities for China export eligibility.',
    coversVi: 'Hạ tầng cổng điện tử kết nối thủ tục đăng ký trực tuyến cho các nhà sản xuất thực phẩm nước ngoài đủ tiêu chuẩn thông quan vào Trung Quốc.',
  ...
  // Japan Regulations (🇯🇵 Accent color: #BC002D)
  {
    ...
    country: 'Japan',
    name: 'JETRO Agricultural & Fishery Import Regulations Guide',
    ...
    coversVi: 'Cẩm nang hướng dẫn đầy đủ nhất về quy phạm thương mại, hàng rào kỹ thuật kiểm dịch đối với nông sản nhập khẩu trực tiếp vào Nhật Bản.',
